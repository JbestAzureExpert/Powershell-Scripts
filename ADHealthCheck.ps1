...
$Smtphost = "smtprelayserverfqdn web01@example.org"
$from = "Emailaddress you would like to use "
$EmailReport = "Email address receiptient" -split ','
$report = ".\ADReport.htm" 
...
#####################################Get ALL DC Servers#######################
$getForest = [system.directoryservices.activedirectory
